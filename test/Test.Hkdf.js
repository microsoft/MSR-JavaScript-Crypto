...
function hkdfTests() {
    ...
    QUnit.test(label + " ts.deriveBitsTest KeyData --> bits ", function(assert) {
        var vectorSet = hkdf.DeriveBits;
    ...
    QUnit.test(label + " ts.deriveKeyTest KeyData --> Aes-Gcm-128 ", function(assert) {
        var vectorSet = hkdf.aes.gcm._128.DeriveKey;
