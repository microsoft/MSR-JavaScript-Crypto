    ...
    var msrCrypto = function() {
        ...
        function MsrcryptoECC() {
            ...
            var EllipticCurvePointFp = function(curve, isInfinity, x, y, z, isInMontgomeryForm) {
                ...
                utils.createProperty(returnObj, "curve", curve, function() {
                    return curve;
                }, function(val) {
                    curve = val;
                });

                utils.createProperty(returnObj, "x", x, function() {
                    return x;
                }, function(val) {
                    x = val;
                });
                utils.createProperty(returnObj, "y", y, function() {
                    return y;
                }, function(val) {
                    y = val;
                });
                utils.createProperty(returnObj, "z", z, function() {
                    return z;
                }, function(val) {
                    z = val;
                });
                ...
                utils.createProperty(returnObj, "isAffine", z === null, function() {
                    return z === null;
                });
            ...
            msrcryptoRsa.exportKey = function(p) {
                ...
                if (p.format === "spki") {
                    var bytes = asn1.encode({
                        SEQUENCE: [{
                                SEQUENCE: [{
                                    "OBJECT IDENTIFIER": RSA_ENCRYPTION
                                }, {
                                    NULL: 1
                                }]
                            },
