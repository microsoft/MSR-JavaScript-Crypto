...
function msrcryptoMath() {
    ...
    function MontgomeryMultiplier(modulus, context) {
        ...
        function getTableEntry(bt, exp, tableVal) {
            ...
            for (z = 0; z < bt[0].length; z++) { tableVal[z] = 0; }
...
var msrcryptoAESKW = function (blockCipher) {
    function encrypt(buffer) {
        ...
        var A = [166, 166, 166, 166, 166, 166, 166, 166];
...
function baseOperation(processResults) {
    ...
    function opDispatchEvent(  e) {
        ...
        if (e.type === "error") {
            if (rejectFunc) {
                if (e.data) {
                    try { if (!e.data.stack) { e.data.stack = "Error"; } } catch (ex) {  }
                    try { if (e.data.code == null) { e.data.code = 0; } } catch (ex) {  }
                }
...
var subtleParameters = [
    { name: "algorithm", type: "Object", required: true },
    { name: "keyHandle", type: "Object", required: true },
    { name: "buffer", type: "Array", required: false },
    { name: "signature", type: "Array", required: true },
    { name: "format", type: "String", required: true },
    { name: "keyData", type: "Object", required: true },
    { name: "extractable", type: "Boolean", required: false },
    { name: "usages", type: "Array", required: false },
    { name: "derivedKeyType", type: "Object", required: true },
    { name: "length", type: "Number", required: false },
    { name: "extractable", type: "Boolean", required: true },
    { name: "usages", type: "Array", required: true },
    { name: "keyData", type: "Array", required: true }
];
